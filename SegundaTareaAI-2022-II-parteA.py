...
# %%
## Log de datos y numero generaciones
log = tools.Logbook()
gens = 50
...
def main():
    ...
    pop = toolbox.population(n=25000)
...
ax2 = ax1.twinx()
line2 = ax2.plot(gen, std_dev, "r-", label="Desviación Estándar")
...
print ("Mejor individuo: ", log.select("ind")[gens-1])
print ("Con un fitness de: ", round(log.select("fit")[gens-1],5))
